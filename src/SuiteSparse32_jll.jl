...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import SuiteSparse32_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("ca45d3f4-326b-53b0-9957-23b75aacb3f2"))
platforms = [Pkg.Artifacts.unpack_platform(e, "SuiteSparse32", artifacts_toml) for e in artifacts["SuiteSparse32"]]
...
if best_platform === nothing
    @debug("Unable to load SuiteSparse32; unsupported platform $(triplet(platform_key_abi()))")
else
